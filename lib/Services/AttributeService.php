...
class AttributeService extends AbstractService
{
    ...
    */
    ...
    {
        $url = "/payout/attribute/{$userToken}";
     ...
     * @param string $destinationToken Token that represents the payout destination i.e. MassPay->Brazil->Bank Deposit->Itau. To be retrieved from the #pricing callback. 
    ...
    */
    ...
    {
        $url = "/payout/attribute/{$userToken}/{$destinationToken}/{$currency}";
        $parameters = new RequestParameters();
