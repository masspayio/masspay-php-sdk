 ...
 */
class AutopayResp implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AutopayResp';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('percentage', $data ?? [], 100);
    }
    ...
    */
     ...
     * Sets token
     *
     * @param string $token Autopay token
     *
     * @return self
     */
     ...
     *
     * @param string $destination_token The destination_token to autopay (send payout to)
     *
     * @return self
     */
     ...
     * Sets percentage
     *
     * @param float $percentage The percent of incoming load that should be autopaid to the destination_token
     *
     * @return self
     */
