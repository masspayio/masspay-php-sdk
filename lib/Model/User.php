...
class User implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets address1
     *
     * @param string|null $address1 The user's street address. Required in order to process a payout.
     *
     * @return self
     */
     ...
     * Sets city
     *
     * @param string|null $city The user's city. Required in order to process a payout.
     *
     * @return self
     */
     ...
     * Sets country
     *
     * @param string $country The user's country code. [ISO_3166](https://en.wikipedia.org/wiki/ISO_3166-1_alpha-3) code. Required in order to process a payout.
     *
     * @return self
     */
    ...
    public function setMobileNumber($mobile_number)
    {
        ...
        if ((!preg_match("/^[0-9]+$/", $mobile_number))) {
            throw new \InvalidArgumentException("invalid value for \$mobile_number when calling User., must conform to the pattern /^[0-9]+$/.");
        }
     ...
     * Sets notify_user
     *
     * @param bool|null $notify_user Should we notify the user via email that their user has been created in the system? They will receive instructions to establish such account.
     *
     * @return self
     */
