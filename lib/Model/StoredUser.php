 ...
 */
class StoredUser implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'StoredUser';
    ...
    */
     ...
     * Sets user_token
     *
     * @param string $user_token Token representing the user that was just created
     *
     * @return self
     */
     ...
     * Sets created_on
     *
     * @param string $created_on The timestamp the user was created in the system. Using UTC timestamp.[ISO 8601](https://en.wikipedia.org/wiki/ISO_8601)
     *
     * @return self
     */
     ...
     * Sets address1
     *
     * @param string|null $address1 The user's street address.
     *
     * @return self
     */
     ...
     * Sets state_province
     *
     * @param string|null $state_province The user's state/province.
     *
     * @return self
     */
     ...
     * Sets postal_code
     *
     * @param string|null $postal_code The user's postal code.
     *
     * @return self
     */
     ...
     * Sets country
     *
     * @param string|null $country The user's country code. ISO_3166-1_alpha-3 code
     *
     * @return self
     */
     ...
     * Sets first_name
     *
     * @param string $first_name The user's first name. (If Business account, the first name of the representative)
     *
     * @return self
     */
     ...
     * Sets middle_name
     *
     * @param string|null $middle_name The user's middle name. (If Business account, the middle name of the representative)
     *
     * @return self
     */
     ...
     * Sets last_name
     *
     * @param string $last_name The user's last name. (If Business account, the last name of the representative)
     *
     * @return self
     */
    ...
    public function setMobileNumber($mobile_number)
    {
        ...
        if ((!preg_match("/^[0-9]+$/", $mobile_number))) {
            throw new \InvalidArgumentException("invalid value for \$mobile_number when calling StoredUser., must conform to the pattern /^[0-9]+$/.");
        }
     ...
     * Sets timezone
     *
     * @param string $timezone User's computed timezone
     *
     * @return self
     */
