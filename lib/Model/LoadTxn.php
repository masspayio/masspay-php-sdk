 ...
 */
class LoadTxn implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LoadTxn';
    ...
    protected static $openAPIFormats = [
        ...
        'notes' => null,
        'notify_user' => null,
        'time_to_process' => 'YYYY-MM-DDThh:mm:ss',
        'metadata' => null
    ];
    ...
    protected static $setters = [
        ...
        'time_to_process' => 'setTimeToProcess',
    ...
    protected static $getters = [
        ...
        'time_to_process' => 'getTimeToProcess',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('notify_user', $data ?? [], true);
        $this->setIfExists('time_to_process', $data ?? [], null);
    ...
    */
     ...
     * Sets notes
     *
     * @param string|null $notes A description for the load. Will be visible to the user receiving the load
     *
     * @return self
     */
    public function setNotes($notes)
    {
        ...
        if ((mb_strlen($notes) > 255)) {
            throw new \InvalidArgumentException('invalid length for $notes when calling LoadTxn., must be smaller than or equal to 255.');
        }
     ...
     * Sets notify_user
     *
     * @param bool|null $notify_user Should we notify the user via email that they've received a load? If the user has no existing account, they will receive instructions to establish such account.
     *
     * @return self
     */
    ...
    /**
     * Gets time_to_process
     *
     * @return string|null
     */
    public function getTimeToProcess()
    {
        return $this->container['time_to_process'];
    }

    /**
     * Sets time_to_process
     *
     * @param string|null $time_to_process Future date/time to process the load on. If none is provided, it is processed right away. Time to be provided in UTC [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601)
     *
     * @return self
     */
    public function setTimeToProcess($time_to_process)
    {
        if (is_null($time_to_process)) {
            throw new \InvalidArgumentException('non-nullable time_to_process cannot be null');
        }
        $this->container['time_to_process'] = $time_to_process;
