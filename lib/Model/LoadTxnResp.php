 ...
 */
class LoadTxnResp implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LoadTxnResp';
    ...
    */
     ...
     * Sets load_token
     *
     * @param string $load_token Token that represents the load that was just created.
     *
     * @return self
     */
     ...
     * Sets status
     *
     * @param string $status Status that indicates whether the transaction was successfully processed. If `COMPLETED`, the load was successfully processed. `CANCELLED` indicates a generic error. and `SCHEDULED` means the load was successfully scheduled
     *
     * @return self
     */
