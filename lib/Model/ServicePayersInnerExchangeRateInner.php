<?php
/**
 * ServicePayersInnerExchangeRateInner
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * ServicePayersInnerExchangeRateInner Class Doc Comment
 *
 * @category Class
 * @package  MassPayPhpSdk
 * @author   OpenAPI Generator team
 ...
 */
class ServicePayersInnerExchangeRateInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Service_payers_inner_exchange_rate_inner';
    ...
    */
     ...
     *
     * @param string $currency_symbol Using [ISO 4217](https://en.wikipedia.org/wiki/ISO_4217) format.
     *
     * @return self
     */
     ...
     * Sets exchange_rate
     *
     * @param float $exchange_rate Estimated rate
     *
     * @return self
     */
