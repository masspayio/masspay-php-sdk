<?php
/**
 * GetUserUserTokenKycAu10tix200Response
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * GetUserUserTokenKycAu10tix200Response Class Doc Comment
 *
 * @category Class
 * @package  MassPayPhpSdk
 * @author   OpenAPI Generator team
 ...
 */
class GetUserUserTokenKycAu10tix200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'get_user_user_token_kyc_au10tix_200_response';
    ...
    */
     ...
     * Sets session_url
     *
     * @param string $session_url URL for Au10tix session that can be used by redirecting the payee to the URL.
     *
     * @return self
     */
