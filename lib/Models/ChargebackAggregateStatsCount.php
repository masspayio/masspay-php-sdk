...
class ChargebackAggregateStatsCount
{
    /**
    ...
    {
        return new ChargebackAggregateStatsCount($data['browsers'], $data['dayOfWeek'], $data['timeOfDay'], $data['platform'], $data['issuers'], $data['paymentSchemes'], $data['transactionOutcomes']);
    }
