...
class RefundAggregateStatsCount
{
    /**
    ...
    {
        return new RefundAggregateStatsCount($data['browsers'], $data['dayOfWeek'], $data['timeOfDay'], $data['platform'], $data['issuers'], $data['paymentSchemes'], $data['transactionOutcomes']);
    }
