...
class TransactionAggregateStatsVolume
{
    /**
    ...
    {
        return new TransactionAggregateStatsVolume($data['browsers'], $data['dayOfWeek'], $data['timeOfDay'], $data['platform'], $data['issuers'], $data['paymentSchemes'], $data['transactionOutcomes']);
    }
