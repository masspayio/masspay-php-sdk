...
class TransactionAggregateStatsCount
{
    /**
    ...
    /**
     * @var int[] $timeOfDay Array of count per hour
     */
    public ?array
    $timeOfDay;
    /**
    ...
    {
        return new TransactionAggregateStatsCount($data['browsers'], $data['dayOfWeek'], $data['timeOfDay'], $data['platform'], $data['issuers'], $data['paymentSchemes'], $data['transactionOutcomes']);
    }
