...
class ChargebackAggregateStatsAmount
{
    /**
    ...
    {
        return new ChargebackAggregateStatsAmount($data['browsers'], $data['dayOfWeek'], $data['timeOfDay'], $data['platform'], $data['issuers'], $data['paymentSchemes'], $data['transactionOutcomes']);
    }
