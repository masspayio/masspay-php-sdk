...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://api.masspay.io/v0.1.4';
     ...
     * @var string
     */
    protected $userAgent = 'MassPay/{language}/{packageVersion}';
    ...
    {
        $report  = 'PHP SDK (MassPayPhpSdk) Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . PHP_VERSION . PHP_EOL;
        $report .= '    The version of the OpenAPI document: 0.1.4' . PHP_EOL;
